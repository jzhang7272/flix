...
- (nonnull __kindof UICollectionViewCell *)collectionView:(nonnull UICollectionView *)collectionView cellForItemAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    NSString *urlSmallString = [NSString stringWithFormat:@"https://image.tmdb.org/t/p/w45%@", movie[@"poster_path"]];
    NSURL *urlSmall = [NSURL URLWithString:urlSmallString];
    NSString *urlLargeString = [NSString stringWithFormat:@"https://image.tmdb.org/t/p/original%@", movie[@"poster_path"]];
